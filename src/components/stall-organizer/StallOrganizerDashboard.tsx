...
import { Store, Users, DollarSign, ArrowRight } from "lucide-react";
                ...
                >
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      {booking.stallManager} - Stall {booking.stallNumber}
                    </p>
                  </div>
...
export default StallOrganizerDashboard;
